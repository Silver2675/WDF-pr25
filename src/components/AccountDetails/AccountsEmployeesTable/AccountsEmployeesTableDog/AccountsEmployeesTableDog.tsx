...
const AccountsEmployeesTableDog = ({ loading }: Props) => {
  if (loading) {
    return (
      <Box sx={mainLayout}>
  ...
  const message = `Sorry, it seems there are no points of contact to display!`
...
export default AccountsEmployeesTableDog
